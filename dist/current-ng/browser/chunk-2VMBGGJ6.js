...
// src/app/components/cards/member-card/member-card.component.ts
var MemberCardComponent = class _MemberCardComponent {
  member;
  static \u0275fac = function MemberCardComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _MemberCardComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MemberCardComponent, selectors: [["app-member-card"]], inputs: { member: "member" }, decls: 25, vars: 3, consts: [[1, "team-auhtor-boxarea"], [1, "images"], ["alt", "", 3, "src"], [1, "team-social-area"], [1, "icons"], ["href", "javascript:void(0)", 1, "plus"], [1, "fa-solid", "fa-plus"], ["href", "javascript:void(0)"], [1, "fa-brands", "fa-instagram"], [1, "fa-brands", "fa-facebook-f"], [1, "fa-brands", "fa-pinterest-p"], [1, "fa-brands", "fa-youtube"], [1, "content-area"], ["routerLink", "/team"]], template: function MemberCardComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275element(6, "i", 6);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(7, "ul")(8, "li")(9, "a", 7);
      \u0275\u0275element(10, "i", 8);
      \u0275\u0275elementEnd()();
    ...
    if (rf & 2) {
      \u0275\u0275advance(2);
      \u0275\u0275property("src", ctx.member.image, \u0275\u0275sanitizeUrl);
      \u0275\u0275advance(20);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MemberCardComponent, [{
    type: Component,
    args: [{ selector: "app-member-card", imports: [RouterLink], template: '<div class="team-auhtor-boxarea">\n    <div class="images">\n        <img [src]="member.image" alt="">\n        <div class="team-social-area">\n            <div class="icons">\n                <a href="javascript:void(0)" class="plus"><i class="fa-solid fa-plus"></i></a>\n                <ul>\n                    <li><a href="javascript:void(0)"><i class="fa-brands fa-instagram"></i></a></li>\n                    <li><a href="javascript:void(0)"><i class="fa-brands fa-facebook-f"></i></a></li>\n                    <li><a href="javascript:void(0)"><i class="fa-brands fa-pinterest-p"></i></a></li>\n                    <li><a href="javascript:void(0)"><i class="fa-brands fa-youtube"></i></a></li>\n                </ul>\n            </div>\n        </div>\n    </div>\n    <div class="content-area">\n        <a routerLink="/team">{{member.name}}</a>\n        <p>{{member.role}}</p>\n    </div>\n</div>' }]
  }], null, { member: [{
    type: Input
  }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MemberCardComponent, { className: "MemberCardComponent", filePath: "src/app/components/cards/member-card/member-card.component.ts", lineNumber: 11 });
})();
...
// src/app/components/cards/pricing-card/pricing-card.component.ts
var _c02 = (a0) => ({ active: a0 });
function PricingCardComponent_li_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li");
    \u0275\u0275element(1, "img", 4);
    \u0275\u0275text(2);
...
var PricingCardComponent = class _PricingCardComponent {
  plan;
  isMonthly;
  static \u0275fac = function PricingCardComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _PricingCardComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PricingCardComponent, selectors: [["app-pricing-card"]], inputs: { plan: "plan", isMonthly: "isMonthly" }, decls: 16, vars: 10, consts: [[1, "single-pricing-area", 3, "ngClass"], [1, "pricing-box"], ["routerLink", "/contact-us", 1, "header-btn1"], [4, "ngFor", "ngForOf"], ["src", "assets/img/icons/check2.svg", "alt", ""]], template: function PricingCardComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(11, "Get a Free Consultaion");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(12, "h4");
      \u0275\u0275text(13);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(14, "ul");
      \u0275\u0275template(15, PricingCardComponent_li_15_Template, 3, 1, "li", 3);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(8, _c02, ctx.plan.active));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(ctx.plan.name);
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate(ctx.plan.description);
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate2("$", ctx.isMonthly ? ctx.plan.monthlyPrice : ctx.plan.yearlyPrice, "/", ctx.isMonthly ? "mo" : "yr", "");
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate(ctx.plan.billingNote);
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(ctx.plan.title);
      \u0275\u0275advance(2);
      \u0275\u0275property("ngForOf", ctx.plan.features);
    }
  }, dependencies: [CommonModule, NgClass, NgForOf, RouterLink], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(PricingCardComponent, [{
    type: Component,
    args: [{ selector: "app-pricing-card", imports: [CommonModule, RouterLink], template: `<div class="single-pricing-area" [ngClass]="{ active: plan.active }" >
    <div class="pricing-box">
        <h3>{{ plan.name }}</h3>
        <p>{{ plan.description }}</p>
        <h2>\${{ isMonthly ? plan.monthlyPrice : plan.yearlyPrice }}/{{ isMonthly ? 'mo' : 'yr' }}</h2>
        <p>{{ plan.billingNote }}</p>

        <a routerLink="/contact-us" class="header-btn1">Get a Free Consultaion</a>

        <h4>{{ plan.title }}</h4>
        <ul>
            <li *ngFor="let feature of plan.features">
                <img src="assets/img/icons/check2.svg" alt=""> {{ feature }}
            </li>
        </ul>
    </div>
</div>` }]
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PricingCardComponent, { className: "PricingCardComponent", filePath: "src/app/components/cards/pricing-card/pricing-card.component.ts", lineNumber: 12 });
})();
...
@angular/animations/fesm2022/animations.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-2VMBGGJ6.js.map
